...
<div class="main">
  ...
  <div class="thumbnail-container">
    <img id="thumbnail" src="/img\RODENTS\RODENT_Environment.jpg" alt="">
    <div class="corner"></div>
  </div>
  <div class="content">
    <div class="header-text">
      <h1 class="h1-text">Proper Environment for Rodents</h1>
    </div>
    <div class="line-bar">
      <hr>
    </div>
    <div class="paragraph-section">
      ...
      <h3>Guinea pigs</h3>
<p>Guinea pigs can be housed together if they are neutered, especially if they are of the opposite sex. Sometimes they fight a little when they are first put together, but with some supervision to avoid serious injury, they will usually establish their own pecking order. Some unneutered males will fight for territory and may never be able to live harmoniously with another guinea pig.</p>

<p>"Guinea pigs can be housed together if they are neutered, especially if they are of the opposite sex."</p>
<p>Animals should be introduced in a neutral territory, such as a fresh, clean cage that neither has been in before. Separate them if the fighting is fierce so they do not injure each other and try again later. It may take a couple of days for them to “work it out”. Sometimes guinea pigs continue to squeak at one another intermittently and appear to be aggressive. Careful observation is necessary to make sure that they are just re-establishing the pecking order and should be given more time to figure out their relationship, but only if neither pet is getting injured.</p>

<h3>Hamsters</h3>
<p>Hamsters are best housed individually. Sexually mature females are aggressive to males and other females. Hamsters do best in multi-level houses with plastic tubes connecting the different levels together.</p>

<h3>Mice</h3>
<p>Male mice are usually housed alone. Female mice rarely fight and are often housed together. Newly assembled male groups, new males entering established territories, and mice previously housed alone are more likely to fight. Bite wounds easily get infected, so close observation is essential when housing multiple mice together.</p>
<a href="https://vcahospitals.com/know-your-pet/rodents-housing">See More</a>
      </div>
    </div>
  </div>
</div>
