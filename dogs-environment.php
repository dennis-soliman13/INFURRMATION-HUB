...
<div class="navbar">
  ...
  <div class="right-section">
    <!-- <div class="search-section">
      ...
      <img class="search-icon" src="/img/search.png" alt="search-icon" onclick="searchWords()">
    </div>
     -->
...
<div class="main">
  ...
  <div class="thumbnail-container">
    <img id="thumbnail" src="/img\DOGS\DOG_EnvironmentCaging.jpeg" alt="">
...
<h3>A Blanket or Crate Cover (Optional)</h3>
...
<a href="https://www.bronteglen.co.uk/blog/what-to-put-in-dog-crate/?srsltid=AfmBOooCvo_4fMW_bbr5zaxYR6-Su_aUtKRmBG3ye4UGBvzU1VAfx1VC">See More</a>
