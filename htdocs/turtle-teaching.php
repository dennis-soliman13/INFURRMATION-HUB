...
<div class="main">
  ...
  <div class="thumbnail-container">
    <img id="thumbnail" src="/img\Turtle\Turtle_Teaching.avif" alt="">
    <div class="corner"></div>
  </div>
  <div class="content">
    <div class="header-text">
      <h1 class="h1-text">Dos and Dont's of Turtles</h1>
    </div>
    <div class="line-bar">
      <hr>
    </div>
    <div class="paragraph-section">
      ...
      <h3>Get used to movement: </h3><p>Gradually get your turtle used to your presence by squatting down and waving from a distance when you cross its tub.</p> 
<h3>Hand feed: </h3><p>Hand feeding can help gain your turtle's trust.</p> 
<h3>Target train: </h3><p>Condition your turtle to associate visual and audible stimuli with food. For example, you can use a red target, which is a color that many tortoises are attracted to. When your turtle touches its nose to the target, you can click a clicker and give it a treat.</p>
      <p>The key is that you let the turtle CHOOSE how much interaction you have with them. And you are super predictable in your actions and movements. And you are BRAVE in scratching the snapper's head and neck. He really looks like he likes it and your other turtles do, too.</p>
