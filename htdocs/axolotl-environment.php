...
<div class="main">
  ...
  <div class="thumbnail-container">
    <img id="thumbnail" src="/pethub/img\Axolotl\axolotl-cute.jpg" alt="">
    <div class="corner"></div>
  </div>
  <div class="content">
    <div class="header-text">
      <h1 class="h1-text">Proper Environment for Axolotl</h1>
    </div>
    <div class="line-bar">
      <hr>
    </div>
    <div class="paragraph-section">
      ...
      <p>Keeping an Axolotl as a pet is one of the most unique and enjoyable adventures an aquarist can embark on.</p>

<p>These creatures are a complete blast. They’re active, engaged with their owners, and unbelievably cute!</p>

<p>But their popularity has led to a lot of misinformation about their care requirements. In fact, most people don’t even know if they’re fully aquatic or not (don’t worry, we’ll cover that).</p>

<p>So if you’re interested in owning one of these pets for yourself, this guide will bring you up to speed on everything you need to know about Axolotl care. You’ll learn about their lifespan, ideal foods, tank setup, temperature, and more!</p>

<p>By the time you’re done reading this, you’ll be very well-prepared if you decide to own one of these creatures in the future.</p>
        
<a href="https://www.aquariumsource.com/axolotl/">See More</a>
      </div>
    </div>
  </div>
</div>
