...
<div class="main">
  ...
  <div class="thumbnail-container">
    <img id="thumbnail" src="/img\CATS\CAT_Environemnt.jpg" alt="">
    <div class="corner"></div>
  </div>
  <div class="content">
    <div class="header-text">
      <h1 class="h1-text">Proper Environment for Cats</h1>
    </div>
    <div class="line-bar">
      <hr>
    </div>
...
<h3>Hiding opportunities: </h3>
<p>Cats' hiding is a natural, adaptive response to a threat, aversive stimuli, or a new environment. As a result, all efforts should be taken to provide caged cats with hiding spots. Hide boxes should be put in the back of the cage, with the opening facing to the side. To aid hiding attempts and provide a sense of security, the cage's roof and three sides should be solid or covered. This will allow the cat to see what is going on outside its cage through the door while feeling physically safe. If the cage is too tiny to accommodate a hide box, putting a towel over a shelf or partially covering the cage door are suitable options. </p>


<h3>Perches: </h3><p>Cats are both prey and predators, hence climbing is an important feline habit. Cats love elevated areas, most likely because it boosts their sense of protection and security. Providing a perch or a box for the cat to sit on can address this requirement while also increasing the amount of useful space in the cage. Perches also give cats the ability to participate in energetic behaviors like climbing. Housing cats in upper-level cages (rather than floor-level cages) can help them feel elevated. </p>


<h3>Bedding: </h3><p>Cats appear to prefer soft resting surfaces, such as pillows or fleece beds, in warm environments, such as safely heated beds or sunny windows. Because most cats prefer familiar bedding, replace it only when it becomes filthy, rather than daily. Even in hospitals, we advocate spot cleaning cages. This is less scary to the cat, reduces the need to remove the cat from the cage for cleaning, and retains familiar aromas in the cage habitat. Bedding may increase traction and comfort on the cage floor.</p>

<h3>Scratching Opportunities: </h3><p>Scratching is a behavior that cats perform to mark territory. It also helps to shed the claw's outer layers, which can be both pleasurable and necessary, as even declawed cats exhibit the behavior. Providing a scratching surface, such as the Stretch & Scratch or a cardboard box, helps kids to express natural behavior in an appropriate way while also providing an outlet for displeasure and activity. Most cats appear to favor a vertical scratcher (Moesta, 2012), although others may prefer a horizontally angled scratching area (Landsberg, 1991). Various sorts and textures of scratching materials should be available to allow the cat to express its preferences. </p>

<h3>Toys:</h3><p>Cats should be given a range of toys that encourage behaviors such as biting, throwing, and chasing. Commercially available puzzle feeders, plush and feather toys, and ping pong balls are all alternatives. Toys allow cats to exercise and relieve frustration. To reduce boredom and enhance object play, toys should be rotated or replaced on a weekly basis. In a shelter, potential adopters will be able to observe cats engaged in pleasant, playful behaviors, which have been identified as crucial adoption considerations.</p>

<h3>Litter pan:</h3><p> To ensure cats' comfort and hygiene, litter pans should be spacious (1.5 times the cat's length) and filled with unscented, fine-grained, deep litter for digging and burying. Feces and filthy litter should be removed twice daily, and the pan cleansed once a week with mild soap. Place the litter pan away from eating and resting places, ideally in the cage's front half, next to a pan from another cage. This layout divides one cat's elimination region from another's resting area, which corresponds to cats' propensity to rest in the cage's rear.</p>

<h3>Food and water:</h3> <p>The type and brand of food should be constant and available at the same times every day. Clean water should be accessible at all times. Offering tiny meals numerous times per day is good for reflecting the feeding patterns of free-roaming cats while also providing more opportunities for socialization. In our experience, many cats dislike having their food combined, thus wet and dry food should be served in separate bowls.</p>

<a href="https://extension.purdue.edu/extmedia/VA/VA-7-W.pdf">See More</a>
      </div>
    </div>
  </div>
</div>
