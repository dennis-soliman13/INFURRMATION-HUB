...
<div class="main">
  ...
  <div class="thumbnail-container">
    <img id="thumbnail" src="/img\Axolotl\axo.jpeg" alt="">
    <div class="corner"></div>
  </div>
  <div class="content">
    <div class="header-text">
      <h1 class="h1-text">Dos and Dont's of Axolotls</h1>
    </div>
    <div class="line-bar">
      <hr>
    </div>
    <div class="paragraph-section">
      ...
      <p>One of the more unusual questions about how to care of an axolotl, owing to their decidedly adorably and non-fish bodies, is “Can I pet it?” Axolotl should be regarded as fish. They may tolerate, and some do seem to enjoy, being petted while in the water, but they don’t want to be handled, cuddled, or otherwise bothered. Worse, their thin skin is permeable, and soaps, chemicals, or oils, including your body’s natural ones, may be absorbed by the animal and harm them.</p>
 
 <p>They should not be removed from water, as doing so may damage them, and they do not voluntarily leave the water. Think of them as fish with legs, and proceed accordingly.</p>
  
 <p>While axolotls remain very popular, they’ve recently suffered an incredible dip in availability in the United States. This is in no small part due to recent federal laws regarding the interstate transport of amphibians. A devastating fungal disease known as chytridiomycosis is wiping out wild populations of amphibians globally, and, unfortunately, it has been spread by the pet trade. Axolotls seem to be pretty resistant to it, but related species of salamanders are not.</p>
  
 <p>Particularly because of their similarity to larval tiger salamanders, which are among some of the most affected species, many states and municipalities have enacted their own laws limiting the availability of axolotls. Be sure to check local laws on purchasing them, and do not release them (or any other aquarium resident, including those you’ve maintained only temporarily) into the wild.</p>
  
 <p>If you take care of your axolotl, this adorable little dragon can live for 20 years or more.</p>
        
 <a href="https://www.tfhmagazine.com/articles/freshwater/axolotl-care-training-feeding-and-more">See More</a>
      </div>
    </div>
  </div>
</div>
