...
<div class="main">
  ...
  <div class="thumbnail-container">
    <img id="thumbnail" src="/img\RODENTS\RODENT_Teaching.webp" alt="">
    <div class="corner"></div>
  </div>
  <div class="content">
    <div class="header-text">
      <h1 class="h1-text">Dos and Dont's of Rodents</h1>
    </div>
    <div class="line-bar">
      <hr>
    </div>
    <div class="paragraph-section">
      ...
      <h3>Here are some tips for teaching rodents:</h3>
<p>Use positive reinforcement: Offer a reward when a rodent performs a desired behavior. </p>
<p>Choose a familiar, quiet room: Train in a place where the rodent is comfortable and free of distractions. </p>
<p>Make sure the rodent is hungry: Ensure the rodent hasn't eaten recently so they are motivated to work for food. </p>
<p>Use free shaping: Place a hoop in front of the rodent and reward them when they show interest. Gradually become more selective about what you reward. </p>
<p>Teach simple commands: Use a rat's favorite foods to teach them to respond to commands like "come", "stand up", or "shake paws". </p>
<p>You can also teach rats to drive tiny cars using a Rodent-Operated Vehicle (ROV). The ROV is made from a clear plastic food container and a robot car kit. Researchers found that rats were highly motivated to drive, often jumping into the car and revving the engine before it moved.</p>
<a href="https://www.twinkl.com.ph/teaching-wiki/rodent">See More</a>
