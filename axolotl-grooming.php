...
<div class="main">
  ...
  <div class="thumbnail-container">
    <img id="thumbnail" src="img\Axolotl\axolotl-grooming.jpeg" alt="">
    <div class="corner"></div>
  </div>
  <div class="content">
    <div class="header-text">
      <h1 class="h1-text">Grooming for Axolotl</h1>
    </div>
    <div class="line-bar">
      <hr>
      <div>
    ...
    <div class="paragraph-section">
      ...
      <p>This is definitely a pet for experienced aquarists. Learning how to care for an Axolotl can take years. They are very sensitive to their environment and need a lot of meticulous cleaning and maintenance.</p>

<p>The tank must be completely cycled before you introduce your Axolotl. New water must be prepared with water conditioner and mineral salts. Then, you will need to perform a 25 to 50% water change on a weekly basis, clearing out ammonia, nitrates, and other waste products to amounts below 20 ppm. Their substrate must also be vacuumed and rinsed, and decorations must be cleaned to prevent fouling.</p>

<p>One key thing to look out for with their care is impaction. This is when an Axolotl swallows something that is too large for it to pass or digest (e.g. large rocks or gravel). This will impair their ability to eat, digest food, or pass a bowel movement. If they have not had any bowel movements in over 2 days, then a blockage is the likely cause.</p>

<p>Impaction can only be treated by surgery. You will need to find a qualified exotics or aquatics vet that specializes in amphibian care.</p>

<p>Another thing to pay attention to is their gills. They can turn pale or wrinkled because of a bacterial infection, a fungal infection, or poor water quality. Most infections can be fixed with a medication regimen or by giving your Axolotl a salt bath.</p>
<a href="https://www.everythingfishkeeping.com/axolotl-care/">See More</a>
      </div>
    </div>
  </div>
</div>
