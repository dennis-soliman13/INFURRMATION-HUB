...
<div class="main">
  ...
  <div class="thumbnail-container">
    <img id="thumbnail" src="/img\Turtle\Turtle_Grooming.jpg" alt="">
    <div class="corner"></div>
  </div>
  <div class="content">
    <div class="header-text">
      <h1 class="h1-text">Grooming for Turtles</h1>
    </div>
    <div class="line-bar">
      <hr>
      <div>
    ...
    <div class="paragraph-section">
      ...
      <h3>Essential Tools And Supplies For Maintaining Your Turtle’S Shell:</h3>
<p>Cleaning your turtle’s shell can be a daunting task if you do not have the right tools. The following are the essential tools and supplies to make the process seamless:</p>

<h3>Soft-bristled toothbrush:</h3> <p>Use a soft-bristled toothbrush to clean away algae and debris from your turtle’s shell.</p>
<h3>Turtle-friendly soap:</h3> <p>Use a mild soap specifically designed for turtles to keep the shell clean and prevent skin irritations.</p>
<h3>Smooth surface for your turtle to rest:</h3> <p>Find a flat, smooth surface for your turtle to rest while grooming to avoid injuring the shell.</p>
<h3>Wiping cloth or towel: </h3><p> Use a clean wiping cloth or towel to dry your turtle’s shell after bathing.</p>
<p>Container large enough for your turtle: Use a container that is sufficiently large to hold your turtle during grooming to help reduce stress.</p>
<a href="https://turtlean.com/pet-turtle-grooming-how-to-keep-your-turtle-clean-and-healthy/">See More</a>
      </div>
    </div>
  </div>
</div>
