...
<div class="main">
  ...
  <div class="thumbnail-container">
    <img id="thumbnail" src="/img\Turtle\Turtle_Nutrition.webp" alt="">
    <div class="corner"></div>
  </div>
  <div class="content">
    <div class="header-text">
      <h1 class="h1-text">Nutrition for Turtles</h1>
    </div>
    <div class="line-bar">
      <hr>
    </div>
