...
<div class="main">
  ...
  <div class="thumbnail-container">
    <img id="thumbnail" src="/img\Hedgehog\hedgehog teaching.png" alt="">
    <div class="corner"></div>
  </div>
  <div class="content">
    <div class="header-text">
      <h1 class="h1-text">Dos and Dont's of Hedgehogs</h1>
    </div>
    <div class="line-bar">
      <hr>
    </div>
    <div class="paragraph-section">
      ...
      <h3>Using the Hedgehog's Sense of Smell to Litter Train</h3>
<p>hedgehog reading a how to litter train a hedgehog manual</p>
<p>Air flow, proximity of the object, and positive or negative reinforcements all affect how your hedgie reacts to smells. With this knowledge, let's discuss cage set-up and its influence on your hedgehog's ability to litter train. If the whole cage smells like poop, a hedgehog will most likely believe the designated poop area is everywhere!</p>

<p>During a recent survey poll we conducted, there were more successfully litter-trained hedgehogs using open wired cages rather than closed ones (such as the plastic totes or aquariums). While it suggests litter training with a closed cage is possible, the success rate is higher in wire cages. The survey also revealed important factors of success such as: the type of litter you use, the location of the litter pan, and the proximity of the litter to the hedgehog's food.</p>
<a href="https://heavenlyhedgies.com/how-to-litter-train-a-hedgehog/">See More</a>
