...
<div class="main">
  ...
  <div class="thumbnail-container">
    <img id="thumbnail" src="img\cj-credits.jpg" alt="">
  
  </div>
  <div class="content">
    <div class="header-text">
      <h1 class="h1-text" style="text-align: center;">Thank You for your Time</h1>
    </div>
    <div class="line-bar">
      <hr>
    </div>
    <div class="paragraph-section">
      <div class="paragraph" style="position:relative;" id="content">
      <img src="/pethub/img/logo2.png" style="position: absolute;
      height: 100px; right: 50px; bottom: 250px;"alt="">
      <img src="/pethub/img/logo2.png" style="position: absolute;
      height: 100px; right: -70px; bottom: 170px;"alt="">
      <img src="/pethub/img/logo2.png" style="position: absolute;
      height: 100px; right: 0px; top: 50px;"alt="">
        <h3 style="text-align: center;">Credits for Group 4</h3>
        <h2 style="text-align: center;">
          Kim Bagtas </h2>
          <h2 style="text-align: center;">Lazhar Espinosa</h2>
          <h2 style="text-align: center;">Francis Ivan Roque</h2>
          <h2 style="text-align: center;">Cj Navarro</h2>
          <h2 style="text-align: center;">Dennis Soliman Jr.</h2>

          <h3 style="text-align: center;">Special Thanks to our Beautiful Professor:</h3>
          <h2 style="text-align: center;">Mam Rhaine Mu&#241;oz</h2>
          <br>
          <p style="text-align: center;"><strong>December 5, 2024</strong></p>
...
<div class="footer">
  <div class="footer-content">
    ...
    <a href="neil.php">
      <p id="group-4-footer">CLICK ME!</p>
    </a>
  </div>
</div>
